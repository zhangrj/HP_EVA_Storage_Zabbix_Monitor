...
str = xmlDoc.loadXML(getXML(selectSys & """ls system " & storages & " XML""", "<object>"))
...
outFile = strTmpLine & "\" & storages & ".txt"
Set objFile = objFSO.CreateTextFile(outFile,True)
objFile.Write trim(send_str)
objFile.Close

objShell.Run """" & zabSend & """ -z " & zabServer & " -p " & zabPort & " -s """ & storages & """  -i """ & outFile & """",0,False
